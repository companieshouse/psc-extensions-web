...
export class TooManyExtensionsHandler extends GenericHandler<PscViewData> {
    ...
    protected override async getViewData (req: Request, res: Response): Promise<PscViewData> {
        ...
        return {
            ...
            templateName: PREFIXED_URLS.EXTENSION_LIMIT_EXCEEDED.slice(1)
        };
    }
    ...
    public async executeGet (req: Request, res: Response): Promise<ViewModel<PscViewData>> {
        ...
        return {
            templatePath: ROUTER_VIEWS_FOLDER_PATH + PATHS.EXTENSION_LIMIT_EXCEEDED,
